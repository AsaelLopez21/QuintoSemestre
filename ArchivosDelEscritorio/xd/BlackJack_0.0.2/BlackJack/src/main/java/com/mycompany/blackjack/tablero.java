...
public class tablero extends javax.swing.JFrame {
   private Barajas barajas;
    ...
    private void TurnoCrupier(){
       ...
       while(crupier.calcularPunuacion()<17){
           crupier.recibirCarta(barajas.sacarCarta());
       }
       crupierContador.setText(("Contador: "+String.valueOf(crupier.calcularPunuacion())));
       crupierCartas.setText("Numero de cartas: "+String.valueOf(crupier.getCartasEnMano()));
    ...
    private void FinalizarJuego(){
        ...
        */
        ...
        int puntuacionJ1=jugadorUno.calcularPunuacion();
        int puntuacionJ2=jugadorDos.calcularPunuacion();
        int puntuacionCrupier=crupier.calcularPunuacion();
        
        if(puntuacionCrupier>21){
            if(puntuacionJ1<21 && puntuacionJ2<21){
                JOptionPane.showMessageDialog(frame, jugadorUno.getNombre()+" y "+jugadorDos.getNombre()+" ganaron");
            }if(puntuacionJ1>21 && puntuacionJ2>21){
                JOptionPane.showMessageDialog(frame, jugadorUno.getNombre()+" y "+jugadorDos.getNombre()+" perdieron");
            }if(puntuacionJ1<21 && puntuacionJ2>21){
                JOptionPane.showMessageDialog(frame, jugadorUno.getNombre()+" gana");
            }if(puntuacionJ2<21 && puntuacionJ1>21){
                JOptionPane.showMessageDialog(frame, jugadorDos.getNombre()+" gana");
            }if(puntuacionJ1 == puntuacionJ2){
                JOptionPane.showMessageDialog(frame, jugadorUno.getNombre()+" y "+jugadorDos.getNombre()+" empatan");
            }
        }if(puntuacionCrupier<=21){
            if(puntuacionJ1<21 && puntuacionJ2<21){
                if(puntuacionJ1>puntuacionJ2){
                    if(puntuacionJ1>puntuacionCrupier){
                         JOptionPane.showMessageDialog(frame, jugadorUno.getNombre()+" gana");
                    }
                }if(puntuacionJ2>puntuacionJ1){
                    if(puntuacionJ2>puntuacionCrupier){
                         JOptionPane.showMessageDialog(frame, jugadorDos.getNombre()+" gana");
                    }
                }
            }if(puntuacionJ1<21 && puntuacionJ2>21){
                ...
                JOptionPane.showMessageDialog(frame, "Crupier gana");
            }
        }
